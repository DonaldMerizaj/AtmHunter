...
public class BankMapActivity extends AppCompatActivity implements OnMapReadyCallback {
...
//        });
    ...
    private void requestLocationPremission() {
        if (checkPermission(android.Manifest.permission.ACCESS_FINE_LOCATION, getApplicationContext(), BankMapActivity.this)) {
        } else {
            requestPermission(android.Manifest.permission.ACCESS_FINE_LOCATION, PERMISSION_REQUEST_CODE_LOCATION, getApplicationContext(), BankMapActivity.this);
        }
    }
